using PAtividade.Forms;
using PAtividade.Utils.ColorTables;
using System;
...
namespace PAtividade
{
    public partial class MainForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.OpenForm(new Exercise1Form());
        }
        ...
        private void OpenForm<T>(T form) where T : Form
        {
            ...
            if (openForm != null)
            {
                ...
                this.titleBar.TitleBarTitle = $"Atividade 7 - {openForm.Text}";
            ...
            else
            {
                ...
                this.titleBar.TitleBarTitle = $"Atividade 7 - {form.Text}";
